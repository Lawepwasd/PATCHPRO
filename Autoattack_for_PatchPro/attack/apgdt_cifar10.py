            ...
            for target_class in range(2, self.n_target_classes + 2):
                ...
                for counter in range(self.n_restarts):
                    ...
                    if ind_to_fool.numel() != 0:
                        ...
                        # judge the model whether has feature_sumnet
                        if hasattr(self.model, "feature_sumnet"):
                            bitmap_to_fool = self.model.feature_sumnet.bitmap[ind_to_fool].clone().to(self.device)
                            self.bitmap = bitmap_to_fool
                        elif hasattr(self.model, "bitmap"):
                            bitmap_to_fool = self.model.bitmap[ind_to_fool].clone().to(self.device)
                            self.bitmap = bitmap_to_fool
